...
{
  new (message_memory) camera_interface_pkg::msg::Points(_init);
}

void Points_fini_function(void * message_memory)
{
  auto typed_message = static_cast<camera_interface_pkg::msg::Points *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Points_message_member_array[2] = {
  {
    ...
    offsetof(camera_interface_pkg::msg::Points, x),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(camera_interface_pkg::msg::Points, y),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Points_message_members = {
  ...
  "Points",  // message name
  2,  // number of fields
  sizeof(camera_interface_pkg::msg::Points),
...
get_message_type_support_handle<camera_interface_pkg::msg::Points>()
{
  return &::camera_interface_pkg::msg::rosidl_typesupport_introspection_cpp::Points_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, camera_interface_pkg, msg, Points)() {
  return &::camera_interface_pkg::msg::rosidl_typesupport_introspection_cpp::Points_message_type_support_handle;
}
